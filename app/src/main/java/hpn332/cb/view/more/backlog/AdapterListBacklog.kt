package hpn332.cb.view.more.backlog
...
//                Utils.goToEdit(inflater!!.context, Type.EDIT_BACKLOG, adapterPosition)
            else
        ...
        override fun onClick(view: View) {
            ...
            // todo
//            if (backlog == null)
//                TaskActivity.onClickBacklog(arrayList!![adapterPosition].id)
//            else
//                editViewModel.backlogId = arrayList!![adapterPosition].id
        }
    }
