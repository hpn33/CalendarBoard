...
import hpn332.cb.view.tag.TagActivity
    ...
    inner class ItemHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun onBind() {
            ...
            view.setOnClickListener {
                Utils.goTo(inflater.context, TagActivity::class.java, id = item.id)
            }

            view.setOnLongClickListener {
                Utils.goToEdit(inflater.context, Type.EDIT_TAG, id = item.id)
